		...
		return {
						...
						if (_ate_dropdown != '') {
							...
							for (var a = 0; a < i.length; a += 1) {
								if (_ate_show_outlook && i[a] == 'outlook') {
									htmx += '<button class="ateoutlook" tabindex="0"  data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'outlook\',\'' + f + '\');">' + _ate_lbl_outlook + '</button>'
								}
								if (_ate_show_google && i[a] == 'google') {
									htmx += '<button class="ategoogle" tabindex="0"   data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'google\',\'' + f + '\');">' + _ate_lbl_google + '</button>'
								}
								if (_ate_show_yahoo && i[a] == 'yahoo') {
									htmx += '<button class="ateyahoo" tabindex="0"  data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'yahoo\',\'' + f + '\');">' + _ate_lbl_yahoo + '</button>'
								}
								if (_ate_show_hotmail && i[a] == 'hotmail') {
									htmx += '<button class="atehotmail" tabindex="0"  data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'hotmail\',\'' + f + '\');">' + _ate_lbl_hotmail + '</button>'
								}
								if (_ate_show_ical && i[a] == 'ical') {
									htmx += '<button class="ateical" tabindex="0"  data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'ical\',\'' + f + '\');">' + _ate_lbl_ical + '</button>'
								}
								if (fbevent && i[a] == 'facebook') {
									if (_ate_show_facebook && i[a] == 'facebook') {
										htmx += '<button class="atefacebook" tabindex="0"  data-ref="' + dropzcx + '" onclick="addthisevent.cli(this,\'facebook\',\'' + f + '\');">' + _ate_lbl_fb_event + '</button>'
									}
								}
							}
						} else {
							...
							if (fbevent) {
								if (_ate_show_facebook) {
									htmx += '<button data-ref="' + dropzcx + '"   tabindex="0" onclick="addthisevent.cli(this,\'facebook\',\'' + f + '\');">' + _ate_lbl_fb_event + '</button>'
								}
							}
						}
			...
			applycss: function(a) {
				if (!css2) {
					...
					b += '.addthisevent_dropdown button {display:block;cursor:pointer;line-height:110%;background:#fff;text-decoration:none;font-size:12px;color:#6d84b4;padding:8px 10px 9px 15px;}';
					b += '.addthisevent_dropdown button:hover {background:#f4f4f4;color:#6d84b4;text-decoration:none;font-size:12px;}';
