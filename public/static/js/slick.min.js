...
(function($) {
    ...
    var defaults = {
        ...
        buttonNextHTML: '<a href="javascript:;" title="Next" class="go-next"></a>',
        buttonPrevHTML: '<a href="javascript:;" title="Previous" class="go-prev"></a>',
    ...
    $.jcarousel = function(e, o) {
        ...
        this.clip.addClass(this.className('jcarousel-clip')).css({
            overflow: 'hidden',
            position: 'relative',
            width:window.screen.width>980?'920px':'230px'
        });
        ...
        if (li.size() > 0) { 
            ...
            this.list.css(this.wh, 230*li.size()+20 + 'px');
        ...
        this.funcNext   = function() {$('.slider-container').find(".jcarousel-item").eq(self.last).css('visibility','visible'); self.next(); };
        this.funcPrev   = function() { $('.slider-container').find(".jcarousel-item").eq(self.first-2).css('visibility','visible');self.prev(); };
    ...
    $jc.fn.extend({
        ...
        setup: function() {
            ...
            $(window).unbind('resize.jcarousel', this.funcResize).on('resize.jcarousel', this.funcResize);
        },
